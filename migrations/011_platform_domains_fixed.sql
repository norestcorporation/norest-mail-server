-- 011_platform_domains_fixed.sql
-- Platform-owned domains and proper address reservation system (fixed version)
...
CREATE TABLE IF NOT EXISTS blocked_addresses (
    ...
    CONSTRAINT blocked_addresses_unique UNIQUE (domain_id, lower(local_part))
);
